...
public class CopShopApp extends Application {
    ...
    public CopShopApp() {
        ...
        // Listings
        ListingObject newListing1 = new ListingObject("", "Sample 1", "This is a sample description that describes this sample listing", "Earth", "9.00", "5", "10");
        ListingObject newListing2 = new ListingObject("", "Sample 2", "This is a description that is a sample to describe this listing", "Earth", "9.00", "5", "10");
        ListingObject newListing3 = new ListingObject("", "Sample 3", "This is a listing sample with a sample description", "Earth", "9.00", "5", "10");
        ListingObject newListing4 = new ListingObject("", "Sample 4", "This is a description for a sample listing, this description is a very long description and should be truncated with ellipsis.", "Earth", "9.00", "5", "10");
        ListingObject newListing5 = new ListingObject("", "Sample 5", "This is a sample description that describes this sample listing", "Earth", "9.00", "5", "10");
        ListingObject newListing6 = new ListingObject("", "Sample 6", "This is a description that is a sample to describe this listing", "Earth", "9.00", "5", "10");
        ListingObject newListing7 = new ListingObject("", "Sample 7", "This is a listing sample with a sample description", "Earth", "9.00", "5", "10");
        ListingObject newListing8 = new ListingObject("", "Sample 8", "This is a description for a sample listing, this description is a very long description and should be truncated with ellipsis.", "Earth", "9.00", "5", "10");
